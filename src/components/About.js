...
class About extends Component {
    render() {
        return (
            ...
            <div>
                <div className="align">
                    <h2 style={{ marginTop: `30px` }}>About Us</h2>
                        ...
                        <div className="home_text">
                            <div className="home_text_align">
                                <p>
                                    ...
                                    In April 2015, we started our second program the Community Clean Ups on Phu Quoc Island. We have, since then, also organized clean ups in Han Noi, HCMC, Hoi An, Hue and Can Tho and have engaged over organizations to join the clean ups.
                                </p><p>
                                ...
                                <p>In developed countries, organizations that combat litter are numerous. We draw our inspiration from them and aspire to be like them. Our main source of inspiration is the four organizations below, including:</p>
                                <ul>
                                    <li>Keep America Beautiful (founded in 1953)</li>
                                    <li>Keep Britain Tidy (founded in 1955)</li>
                                    <li>Keep Australia Beautiful (founded in 1969)</li>
                                    <li>Don’t Mess With Texas (founded in 1985)</li>
                                </ul>
                                

                                <p>Since all of them were established for so many years ago and still exist until today, we believe that this battle will take patience and endurance.
                                </p>
                            </div>
                        </div>
