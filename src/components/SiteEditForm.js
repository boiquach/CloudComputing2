...
class SiteEditForm extends Component {
    ...
    this.state = {
      ...
      errors: [
        ...
        },
        {
          ...
          state: false,
          warn:
            "Please provide a valid image! Accepted types are jpeg, jpg and png."
        }
      ],
      file: null
    };
  ...
  submit = () => {
    const site = {
      ...
      owner: sessionStorage.getItem("member")
    };
          ...
          <div className="site_form edit">
            ...
            <div>
              ...
              <DatePicker
                ...
                selected={
                  this.state.datetime !== null ? this.state.datetime : minDate
                }
              />
            </div>
                  ...
                  <div className="form-group form-check">
                    <label className="form-check-label">
                      <input
                        ...
                        type="radio"
                        value={choice}
                        checked={this.state.container === choice}
                      />
                      {choice}
                    </label>
                  </div>
            ...
            <div>
              <button className="next fill" onClick={this.submit.bind(this)}>
                Update
              </button>
              <button className="next" onClick={this.props.closeEdit}>
                Close
              </button>
            </div>
          </div>
