...
import { fetchSitesByUser } from "../Redux/actions/siteAction";
                      ...
                      return (
                        <div className="site_card" key={site.id}>
                          ...
                          <ul>
                            ...
                            <li>
                              <b>Date: </b>
                              {`${new Date(site.info.datetime.seconds * 1000)}`}
                            </li>
                          </ul>
                          <br />
                          <div className="align">
                            <a href={`/report/${site.id}`}>Outcome Report</a>
                          </div>
                        </div>
                      );
                    })}
