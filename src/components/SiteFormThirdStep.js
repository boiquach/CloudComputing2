    ...
    return(
        <form onSubmit = {handleSubmit}>
            ...
            <div>
                ...
                <div className="form-group form-check">
                    <label className="form-check-label"><Field className="form-check-input" name="kit" type="radio" component="input" value="10" />{''}10</label>
                </div>
                <div className="form-group form-check">
                    <label className="form-check-label"><Field className="form-check-input" name="kit" type="radio" component="input" value="20" />{''}20</label>
                </div>
                <div>
            ...
            <div>
                ...
                <div className="form-group form-check">
                    <label className="form-check-label"><Field className="form-check-input" name="container" type="radio" component="input" value="No" />{''}No</label>
                    </div>
                <div>
            ...
            <div className="align">
                ...
                <div className="align">
                <button type="submit" disabled={pristine || submitting} className="next fill">Submit</button></div>
            </div>
        </form>
